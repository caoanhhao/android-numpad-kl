...
package vn.caoanhhao.androidnumpadkl;
...
public class MainActivity extends Activity {
    ...
    private static final String CHANGELOG = "https://github.com/caoanhhao/android-numpad-kl/releases";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hideSwitch.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Removing App from launcher", Toast.LENGTH_LONG).show();
                finish();
            }
        });
